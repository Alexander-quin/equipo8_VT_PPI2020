...
import "../estilo/pota.css";
function potabili() {
  return (
    <>
      <div class="Her">
        <h1>Metodos de potabilización </h1>
      </div>
      <p class="espa"></p>
      <h2>METODOS</h2>
